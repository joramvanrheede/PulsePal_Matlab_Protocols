...
% This script moves stimulator 1 and 2 back and forth, holding the maximum
% deviation position for a short while
...
led_delays              = [.1]; % LED stimulus delays in s
...
for a = 1:n_stims
    ...
    elseif this_whisk_stim == 2
        this_whisk_wave         = waveform_volts * v_max_2; % multiply waveform by target max voltage
    end
