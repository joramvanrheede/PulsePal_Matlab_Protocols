...
led_delays              = [.5 .8 .9 .95 1 1.05 1.1 1.2 1.5 4 4 4]; % LED stimulus delays in s
...
trial_spacing           = 12.5; % Space between TRIGGERS for successive trials; NOTE - trial spacing incorporates time of trial execution; 
