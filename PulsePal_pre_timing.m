...
led_delays              = [.8 .85 .9 .925 .95 .975 1 2.5 2.5]; % LED stimulus delays in s
...
trial_spacing           = 6; % Space between TRIGGERS for successive trials; NOTE - trial spacing incorporates time of trial execution; 
