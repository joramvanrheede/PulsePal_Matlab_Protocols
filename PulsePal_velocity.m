...
whisk_wave_freq         = [2 5 10 20 40 100]; % Whisker stimulus velocity (frequency of WAVEFORM in Hz)
whisk_trig_freq         = [2]; % !!! Values must be lower or equal to any 'whisk_wave_freq' value !!! Whisker stimulus triggering frequency (frequency of successive stimuli in HZ)

led_delays              = [.75 3.75]; % LED stimulus delays in s
