...
whisk_trig_freq         = [1 3 5 10 15]; % !!! Values must be LOWER THAN every 'whisk_wave_freq' value !!! Whisker stimulus triggering frequency (frequency of successive stimuli in HZ)
...
n_repeats               = 5; % How many repeats of each parameter combination?
...
trial_spacing           = 13; % Space between TRIGGERS for successive trials; NOTE - trial spacing incorporates time of trial execution; 
